...
class GraphGCN(torch.nn.Module):
    ...
    def __init__(self, num_features, num_classes):
        ...
        self.conv1 = GCNConv(num_features, 20, normalize=False)
        self.relu1 = ReLU()
        self.conv2 = GCNConv(20, 20, normalize=False)
        self.relu2 = ReLU()
        self.conv3 = GCNConv(20, 20, normalize=False)
        self.relu3 = ReLU()
